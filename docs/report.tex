...
The probabilistic generative model uses probability distributions from \cite{tempereley2007music} to generate the next note as a function of the previous note. Additionally, mutations of possible accompaniments occur probabilistically.
